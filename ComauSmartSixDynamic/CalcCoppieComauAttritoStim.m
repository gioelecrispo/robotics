...
B = MatriceInerziaStim(qDH);
Inerzia = B*ddqDH;

Centrifugo(:,1) = CCentrifugoCoriolisStim(qDH, dqDH);
Attr_Viscoso(:,1) = CAViscosoStim(dqDH);
Gravita(:,1) = CGravitaStim(qDH);
Attr_Statico(:,1) = CAStaticoStim(dqDH);
